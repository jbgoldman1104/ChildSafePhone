...
public class ChildSafeEditAContact2Activity extends ChildSafeActivity {
	
	SharedPreferences contactInfo;
	static final int BROWSE_DIALOG_ID = 0;
	int initIcon = CHILDSAFE_PREFERENCES_CONTACT2ICON;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		editContactEditText.setText(contactInfo.getString(CHILDSAFE_PREFERENCES_CONTACT2NAME, ""));
		editContactEditNumber.setText(contactInfo.getString(CHILDSAFE_PREFERENCES_CONTACT2PHONE, ""));
		editIcon.setImageResource(contactInfo.getInt("CHILDSAFE_PREFERENCES_CONTACT2ICON", R.drawable.icon00));
		
		initIcon= contactInfo.getInt("CHILDSAFE_PREFERENCES_CONTACT2ICON", R.drawable.icon00);
	...
	private void  buttonOKEditScreen(){
        ...
        cancelEditAContactButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
				...
				final EditText editContactEditText2 = (EditText) findViewById(R.id.editTextName);
				final EditText editContactEditNumber2 = (EditText) findViewById(R.id.editTextPhone);
				final ImageView editIcon = (ImageView) findViewById(R.id.imageViewIcon);

				//Displays what is being edited (Name, Phone, Icon)
				String strEditContactName2 = editContactEditText2.getText().toString();
                String strEditContactNumber2 = editContactEditNumber2.getText().toString();
                editIcon.setImageResource(contactInfo.getInt("CHILDSAFE_PREFERENCES_CONTACT2ICON", R.drawable.icon00));
                   
                	//Commit the following changes when clicked ok
                	Editor editor = contactInfo.edit();
                    editor.putString(CHILDSAFE_PREFERENCES_CONTACT2NAME, strEditContactName2);
                    editor.commit();
                    editor.putString(CHILDSAFE_PREFERENCES_CONTACT2PHONE, strEditContactNumber2);
                    editor.commit();
                    startActivity(new Intent(ChildSafeEditAContact2Activity.this,ChildSafeParentSettingActivity.class));
            }
        });
	}
	...
	private void  buttonCancelEditScreen(){
        ...
        cancelEditAContactButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	...
            	Editor editor = contactInfo.edit();
                editor.putInt("CHILDSAFE_PREFERENCES_CONTACT2ICON", initIcon);
                editor.commit();
            	
                startActivity(new Intent(ChildSafeEditAContact2Activity.this,ChildSafeEditContactActivity.class));
            }
        });
	}
		...
		case BROWSE_DIALOG_ID: 
			...
			for (int curIcon = 0; curIcon <= 9; curIcon++){
				...
				curImgView.setOnClickListener(new View.OnClickListener() {
					public void onClick(View v) {			
						...
						Editor editor = contactInfo.edit();
		                editor.putInt("CHILDSAFE_PREFERENCES_CONTACT2ICON", R.drawable.icon00 + currentValue);
		                editor.commit();
		                ...
		                //remove the dialog
		                ChildSafeEditAContact2Activity.this.removeDialog(BROWSE_DIALOG_ID);
					}
				});	
			}
			...
			for (int curIcon = 0; curIcon <= 9; curIcon++){
				...
				curImgView.setOnClickListener(new View.OnClickListener() {
					public void onClick(View v) {
						//sets the preferences of the icon being chosen
						Editor editor = contactInfo.edit();
		                editor.putInt("CHILDSAFE_PREFERENCES_CONTACT2ICON", R.drawable.icon10 + currentValue1);
		                editor.commit();
			...
			curImgView2.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					//sets the preferences of the icon being chosen
					Editor editor = contactInfo.edit();
	                editor.putInt("CHILDSAFE_PREFERENCES_CONTACT2ICON", R.drawable.icon20);
	                editor.commit();
			...
			builder.setNegativeButton(android.R.string.cancel,
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
								int whichButton) {
							ChildSafeEditAContact2Activity.this
