...
public class ChildSafeEditAContact5Activity extends ChildSafeActivity {
	
	SharedPreferences contactInfo;
	static final int BROWSE_DIALOG_ID = 0;
	int initIcon = CHILDSAFE_PREFERENCES_CONTACT5ICON;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		editContactEditText.setText(contactInfo.getString(CHILDSAFE_PREFERENCES_CONTACT5NAME, ""));
		editContactEditNumber.setText(contactInfo.getString(CHILDSAFE_PREFERENCES_CONTACT5PHONE, ""));
		editIcon.setImageResource(contactInfo.getInt("CHILDSAFE_PREFERENCES_CONTACT5ICON", R.drawable.icon00));
		
		initIcon = contactInfo.getInt("CHILDSAFE_PREFERENCES_CONTACT5ICON", R.drawable.icon00);
	...
	private void  buttonOKEditScreen(){
        ...
        cancelEditAContactButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
				...
				final EditText editContactEditText5 = (EditText) findViewById(R.id.editTextName);
				final EditText editContactEditNumber5 = (EditText) findViewById(R.id.editTextPhone);
				
				//Retrieves the Edit Text and puts it into a string variable
				String strEditContactName5 = editContactEditText5.getText().toString();
                String strEditContactNumber5 = editContactEditNumber5.getText().toString();
                   
                	//Commit the following changes when clicked ok
                	Editor editor = contactInfo.edit();
                    editor.putString(CHILDSAFE_PREFERENCES_CONTACT5NAME, strEditContactName5);
                    editor.commit();
                    editor.putString(CHILDSAFE_PREFERENCES_CONTACT5PHONE, strEditContactNumber5);
                    editor.commit();
                    startActivity(new Intent(ChildSafeEditAContact5Activity.this, ChildSafeParentSettingActivity.class));
            }
        });
	}
	...
	private void  buttonCancelEditScreen(){
        ...
        cancelEditAContactButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	...
            	Editor editor = contactInfo.edit();
                editor.putInt("CHILDSAFE_PREFERENCES_CONTACT5ICON", initIcon);
                editor.commit();
                startActivity(new Intent(ChildSafeEditAContact5Activity.this,ChildSafeEditContactActivity.class));
            }
        });
	}
	...
	protected Dialog onCreateDialog(int id) { 
		...
		case BROWSE_DIALOG_ID: 
			...
			for (int curIcon = 0; curIcon <= 9; curIcon++){
				...
				curImgView.setOnClickListener(new View.OnClickListener() {
					public void onClick(View v) {			
						...
						Editor editor = contactInfo.edit();
		                editor.putInt("CHILDSAFE_PREFERENCES_CONTACT5ICON", R.drawable.icon00 + currentValue);
		                editor.commit();
		                ...
		                //remove the dialog
		                ChildSafeEditAContact5Activity.this.removeDialog(BROWSE_DIALOG_ID);
					}
				});	
			}
			...
			for (int curIcon = 0; curIcon <= 9; curIcon++){
				...
				//ImageView curImgView = (ImageView) layout.findViewById(R.id.imageView00 + curIcon);
				curImgView.setOnClickListener(new View.OnClickListener() {
					public void onClick(View v) {
						//sets the preferences of the icon being chosen
						Editor editor = contactInfo.edit();
		                editor.putInt("CHILDSAFE_PREFERENCES_CONTACT5ICON", R.drawable.icon10 + currentValue1);
		                editor.commit();
			...
			curImgView2.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					//sets the preferences of the icon being chosen
					Editor editor = contactInfo.edit();
	                editor.putInt("CHILDSAFE_PREFERENCES_CONTACT5ICON", R.drawable.icon20);
	                editor.commit();
			...
			builder.setNegativeButton(android.R.string.cancel,
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
								int whichButton) {
							ChildSafeEditAContact5Activity.this
